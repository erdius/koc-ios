...
enum LeadershipDirectory {
    static let developer: [LeadershipContact] = [
    ...
    static let officers: [LeadershipContact] = [
        ...
        LeadershipContact(name: "Deacon Brian Phillips", title: "Chaplain", email: "dreed@stmichaelcary.org"),
    ...
    static let directors: [LeadershipContact] = [
        ...
        LeadershipContact(name: "Ralph Becker", title: "Digital Committee", email: "ralphgb@gmail.com"),
        LeadershipContact(name: "Vito Stellato", title: "Hospitality", email: "vito.stellato@yahoo.com"),
        ...
        LeadershipContact(name: "Will Trower", title: "Cor Director", email: "membership@kofc6650.org"),
